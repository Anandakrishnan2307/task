...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="<?php echo base_url(); ?>app-assets/img/core-img/favicon.png">
    <!-- CSS Libraries-->
...
function goBack() {
  window.history.back();
          ...
          <div class="page-heading">
            <h6 class="mb-0"><?php echo strtoupper($user); ?></h6>
          </div>
          <!-- Navbar Toggler-->
    ...
    <div class="sidenav-wrapper" id="sidenavWrapper">
      ...
      <div class="sidenav-profile">
        ...
        <!-- User Info-->
        <div class="user-info">
          <h6 class="user-name mb-0"><?php if(isset($_SESSION['user'])) echo $_SESSION['user']; ?></span>
        </div>
      </div>
      <!-- Sidenav Nav-->
...
<li><a href="<?php echo base_url(); ?>category">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-justify" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M2 12.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm0-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z"/>
</svg>Category</a></li>

<li><a href="<?php echo base_url(); ?>sub_category">
